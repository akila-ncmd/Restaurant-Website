...
export const testimonialData: TestimonialData = {
  ...
  items: [
    ...
    { name: 'Charles Richard', role: 'Product Manager', image: '/images/avatar-3.jpg', review: 'Excellent service, beautiful presentation, and quick delivery make EatBest a reliable choice I happily recommend to everyone.', rating: 4 },
  ],
};
...
export const blogData: BlogData = {
  ...
  posts: [
    { image: '/images/blog-1.jpg', category: 'Pizza', date: 'Jan 10, 2023', author: 'EatBest Team', title: 'What Makes a Perfect Cheese Pizza?', excerpt: 'From dough to toppings, discover the secrets behind a truly delicious cheese pizza.', link: '/blog' },
    { image: '/images/blog-2.jpg', category: 'Burger', date: 'Jan 08, 2023', author: 'EatBest Team', title: 'How We Craft Juicy Burgers Every Time', excerpt: 'Learn how EatBest prepares juicy, flavorful burgers using premium ingredients.', link: '/blog' },
    { image: '/images/blog-3.jpg', category: 'Chicken', date: 'Jan 05, 2023', author: 'EatBest Team', title: "Why Fresh Ingredients Are Our Best", excerpt: "Fresh ingredients make all the difference. Here's why quality matters at EatBest.", link: '/blog' },
  ],
};
